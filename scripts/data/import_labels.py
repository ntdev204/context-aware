...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", type=Path, required=True, help="Path to YOLO formatted export directory")
    parser.add_argument("--output", type=Path, default=Path("intent_dataset/human"), help="Output dataset directory")
